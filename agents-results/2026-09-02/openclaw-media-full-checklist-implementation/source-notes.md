...
- 要求来源 SHA-256：`88f32d8d882d3c98bf152c87e31ef6bf0dd7f94701a6db03e39e5bfeaa0697bf`
- 视觉原型：`agents-results/2026-09-01/openclaw-media-ui-prototype-and-checklist/openclaw-media-ui-prototype.html`
- 视觉原型 SHA-256：`12333526096c18d2dc0e4a0f4b49d804d0f3cf5683117730ce415e3665686978`
...
| D2 | 已拍板的三件事 | build | PARTIAL | `99_System_OpenClaw/scripts/15_register_reusable_asset.py:56` | `302bfbb04e8a93b8ec4d4d81967dcc396aba1db3eade2e1f88c03269e5f0df96` |
| D3 | 已拍板的三件事 | build | BLOCKED_DECISION | `99_System_OpenClaw/scripts/03_transcribe_audio.py:198` | `e2581e9d1c0dfa8aa1d3d55965b3693cad6fce1dc8fbbc63f0fd7bdd5e8dd62a` |
| A1 | 登录与安装向导 | build | PARTIAL | `99_System_OpenClaw/desktop/upstream_session.py:69` | `d40f9c169b8d069256d430ba99478845bedc4d4ee63c067a78d94e7e5ea9f4e2` |
...
| H1 | 工作台 | ready | PARTIAL | `99_System_OpenClaw/desktop/project_store.py:94` | `62505f0198d94492f7928a09ac65eef3cb47ae987a251f9bf2e69a12f276fe60` |
| H2 | 工作台 | build | PARTIAL | `99_System_OpenClaw/desktop/server.py:311` | `f41f5f096b62a26cf2abce887bfa589f1d95645f3af3d9974e1b363467c24c69` |
| H3 | 工作台 | build | NOT_READY | `99_System_OpenClaw/scripts/15_register_reusable_asset.py:12` | `1e441c9f3b9c026906311db527424ed651d5d86e0007485a54a0ce603dd7aa44` |
| H4 | 工作台 | build | NOT_READY | `99_System_OpenClaw/desktop/project_store.py:228` | `7c963a415ec7a8d8d2b61f93c771c2094a55e4fddab31c2561b6a326c3ef7555` |
...
| L1 | 素材库 | build | NOT_READY | `99_System_OpenClaw/scripts/15_register_reusable_asset.py:56` | `0d73f9f416d542b54dda41d761623095dbc0ddaffc61f58fe764ddcb5fad362a` |
| L2 | 素材库 | build | NOT_READY | `99_System_OpenClaw/scripts/15_register_reusable_asset.py:63` | `3eacbc24ba837aa8bd0ddacae52aeea7904ef6ba12bcb52773512ac0ab3d0109` |
...
| P2 | 项目 | ready | NOT_READY | `99_System_OpenClaw/scripts/edit_backends/otio_kdenlive.py:56` | `370b1698151feaf7ceb610cf60406cd76144b7fad3330ae7f30e7bb10eec86f5` |
| P3 | 项目 | fix | NOT_USER_ACCESSIBLE | `99_System_OpenClaw/desktop/static/app.js:15` | `1645f1d6a7c955af49b7c5e6ad1d2a75c526be0fe9caa9ba9e34aa814117cf7a` |
...
| S1 | 设置与诊断 | ready | PARTIAL | `99_System_OpenClaw/scripts/analysis_tiering.py:22` | `78a6ab868a769129410aae2fb2513ad4c457c71d1538428fdb3d821a38783aa4` |
...
| S3 | 设置与诊断 | ready | PARTIAL | `99_System_OpenClaw/scripts/43_content_os_doctor.py:41` | `f07a378f3eb22333d54a54155a726e875cabe52857a1f16c3e5e014fe3570062` |
...
| T1 | 接界面之前该还的债 | build | PARTIAL | `99_System_OpenClaw/tests/test_promote_inbox_batch_to_project.py:20` | `56383d571da30fb227a738021ab02cd4a8ac6294631b56f2fe5b36941b8754ae` |
| T2 | 接界面之前该还的债 | build | NOT_READY | `99_System_OpenClaw/scripts/12_select_repeat_photo_groups.py:269` | `3ba7338a27bb54f01b8cd5f14059a6764498a753e0de93de5aea58a1e8757da2` |
...
| T4 | 接界面之前该还的债 | build | NOT_READY | `99_System_OpenClaw/scripts/analysis_tiering.py:18` | `bca41792617d2f3beaa2391cdcb018ed705f53f9eb0904cf407531fa2fa4b7c8` |
| T5 | 接界面之前该还的债 | ready | PARTIAL | `99_System_OpenClaw/desktop/server.py:280` | `cc526f681ae04ad05ec73433cf1db27dfcb6a9fbf76a9b41358dc31b32cb7470` |
...
| K3 | 换界面时不要丢的东西 | fix | PARTIAL | `99_System_OpenClaw/desktop/project_store.py:55` | `bb42356400e18dbe3c6cab632a28bddbf5dbc0b514d898f467272d63a3a5025d` |
| K4 | 换界面时不要丢的东西 | fix | PARTIAL | `99_System_OpenClaw/desktop/project_store.py:105` | `1b251c23eb82cdd0ef41c730c2fe0b3f2d5b225b2a7ec4070a86d167755d6c16` |
| K5 | 换界面时不要丢的东西 | fix | PARTIAL | `99_System_OpenClaw/desktop/project_store.py:17` | `292a85f96b6f474aff295829bca32be75b4510d32560dd76c63820ba0f4fe033` |
