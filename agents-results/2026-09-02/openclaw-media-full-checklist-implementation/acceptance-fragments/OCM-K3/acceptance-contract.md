...
| AC-02 | behavior | machine/local-runtime | SRC-CHECKLIST-K3 | 上游输入变化后 stale 状态传播到所有受影响下游；未受影响文档不得被连带失效。 | Automatic | Yes |
...
| AC-02 | 失败、重试与恢复自动验收 | acceptance-fragments/OCM-K3/acceptance/machine/local-runtime/runs/&lt;run-id&gt;/result.md | Automatic | Yes |
