...
| AC-02 | behavior | machine/local-runtime | SRC-CHECKLIST-L1 | 索引缺失、损坏或版本不兼容时显示可修复错误，不得从展示卡片猜测结构化事实或返回伪造素材。 | Automatic | Yes |
...
| AC-02 | 失败、重试与恢复自动验收 | acceptance-fragments/OCM-L1/acceptance/machine/local-runtime/runs/&lt;run-id&gt;/result.md | Automatic | Yes |
