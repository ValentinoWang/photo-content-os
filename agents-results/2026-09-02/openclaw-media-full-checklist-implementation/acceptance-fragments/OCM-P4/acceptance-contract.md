...
| AC-02 | behavior | machine/local-runtime | SRC-CHECKLIST-P4 | 待补素材逐项保留用途、约束和状态；缺失项不得被标记完成，加入素材后必须回读更新。 | Automatic | Yes |
...
| AC-02 | 失败、重试与恢复自动验收 | acceptance-fragments/OCM-P4/acceptance/machine/local-runtime/runs/&lt;run-id&gt;/result.md | Automatic | Yes |
