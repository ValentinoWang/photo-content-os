...
| AC-02 | behavior | machine/local-runtime | SRC-CHECKLIST-C1 | 网页中台只投影用户已配对身份可见的任务；会话失效返回明确空态/认证态且不影响本地工作台。 | Automatic | Yes |
...
| AC-02 | 失败、重试与恢复自动验收 | acceptance-fragments/OCM-C1/acceptance/machine/local-runtime/runs/&lt;run-id&gt;/result.md | Automatic | Yes |
