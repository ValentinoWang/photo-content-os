...
| AC-02 | behavior | machine/local-runtime | SRC-CHECKLIST-S5 | 提供方、模型、端点、思考强度和密钥引用可配置并被真实执行链消费；密钥明文不得写盘或回显。 | Automatic | Yes |
...
| AC-02 | 失败、重试与恢复自动验收 | acceptance-fragments/OCM-S5/acceptance/machine/local-runtime/runs/&lt;run-id&gt;/result.md | Automatic | Yes |
