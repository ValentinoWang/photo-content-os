...
| AC-02 | behavior | machine/integration-contract | SRC-CHECKLIST-T5 | 前置、权限、路径、版本、能力或外部系统异常时失败关闭，不伪造成功且可重试或恢复 | Automatic | Yes |
...
| --- | --- | --- | --- | --- |
| AC-01 | 正常闭环自动验收 | acceptance-fragments/OCM-T5/acceptance/machine/e2e/runs/&lt;run-id&gt;/result.md | Automatic | Yes |
