...
| AC-02 | behavior | machine/local-runtime | SRC-CHECKLIST-P2 | 时间线只消费结构化 EDL；轨道、片段、入出点和素材引用非法时不渲染可执行候选。 | Automatic | Yes |
...
| AC-02 | 失败、重试与恢复自动验收 | acceptance-fragments/OCM-P2/acceptance/machine/local-runtime/runs/&lt;run-id&gt;/result.md | Automatic | Yes |
