...
| AC-02 | behavior | machine/local-runtime | SRC-CHECKLIST-K2 | 每版可查看 diff 并回滚到明确版本；回滚产生新 revision，不重写或删除历史版本。 | Automatic | Yes |
...
| AC-02 | 失败、重试与恢复自动验收 | acceptance-fragments/OCM-K2/acceptance/machine/local-runtime/runs/&lt;run-id&gt;/result.md | Automatic | Yes |
