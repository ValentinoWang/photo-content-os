...
| AC-02 | behavior | machine/local-runtime | SRC-CHECKLIST-H3 | 本周统计从真实索引和任务时间窗口聚合；空数据为零值空态，损坏记录不得被计入成功统计。 | Automatic | Yes |
...
| AC-02 | 失败、重试与恢复自动验收 | acceptance-fragments/OCM-H3/acceptance/machine/local-runtime/runs/&lt;run-id&gt;/result.md | Automatic | Yes |
