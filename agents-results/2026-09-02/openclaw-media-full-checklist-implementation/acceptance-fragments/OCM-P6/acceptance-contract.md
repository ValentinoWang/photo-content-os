...
| AC-02 | behavior | machine/local-runtime | SRC-CHECKLIST-P6 | 界面和文档统一表述剪映生产路线停止维护；不得声称草稿加密，也不得修改生产剪映草稿。 | Automatic | Yes |
...
| AC-02 | 失败、重试与恢复自动验收 | acceptance-fragments/OCM-P6/acceptance/machine/local-runtime/runs/&lt;run-id&gt;/result.md | Automatic | Yes |
