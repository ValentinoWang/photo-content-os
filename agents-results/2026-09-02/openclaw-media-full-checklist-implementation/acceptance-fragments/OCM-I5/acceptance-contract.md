...
| AC-02 | behavior | machine/local-runtime | SRC-CHECKLIST-I5 | 仅用户选中的候选进入当前操作系统回收站；永久删除被禁止，平台失败逐文件报告并保留可恢复状态。 | Automatic | Yes |
...
| AC-02 | 失败、重试与恢复自动验收 | acceptance-fragments/OCM-I5/acceptance/machine/local-runtime/runs/&lt;run-id&gt;/result.md | Automatic | Yes |
