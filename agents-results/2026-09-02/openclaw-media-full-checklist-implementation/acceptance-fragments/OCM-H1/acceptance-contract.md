...
| AC-02 | behavior | machine/local-runtime | SRC-CHECKLIST-H1 | 首页六段业务命名与项目五段字段投影必须显式对齐；未知阶段显示受控兜底，不得错算当前进度。 | Automatic | Yes |
...
| AC-02 | 失败、重试与恢复自动验收 | acceptance-fragments/OCM-H1/acceptance/machine/local-runtime/runs/&lt;run-id&gt;/result.md | Automatic | Yes |
