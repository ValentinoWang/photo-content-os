...
| AC-02 | behavior | machine/local-runtime | SRC-CHECKLIST-C3 | 复制报告包含候选提交、内容摘要、状态和错误边界；缺少上游证据时不得展示已发布或已完成。 | Automatic | Yes |
...
| AC-02 | 失败、重试与恢复自动验收 | acceptance-fragments/OCM-C3/acceptance/machine/local-runtime/runs/&lt;run-id&gt;/result.md | Automatic | Yes |
